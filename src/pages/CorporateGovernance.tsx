  ...
  const governanceItems = [
    {
      ...
      title: "2022",
      content:
        "Access our comprehensive corporate governance documents and compliance materials for 2022.",
      documents: [
        {
          id: "2022-1",
    ...
    },
    {
      ...
      title: "2023",
      content:
        "View our complete corporate governance documentation for 2023, featuring updated policies, compliance reports, and organizational frameworks.",
      documents: [
        {
          id: "2023-1",
          name: "2023 Annual Corporate Governance Report",
          fileName:
            "2023/2023 Annual Corporate Governance Report ( Submitted to the Insurance Commission ).pdf",
          fileType: "PDF",
          fileSize: "1,263 KB",
        },
        {
          ...
          fileName:
            "2023/2023_MICI Audited Financial Statement_Received by BIR and SEC.pdf",
          fileType: "PDF",
          fileSize: "10,832 KB",
        },
        {
        ...
        },
        {
          ...
          fileName:
            "2023/METROPOLITAN-AUDIT-AND-RISK-OVERSIGHT-COMMITEE-CHARTER.pdf",
          fileType: "PDF",
          fileSize: "243 KB",
        },
        {
        ...
        },
        {
          ...
          fileName:
            "2023/METROPOLITAN-CORPORATE-GOVERNANCE-COMMITEE-CHARTER.pdf",
          fileType: "PDF",
          fileSize: "232 KB",
        },
        {
        ...
        },
        {
          ...
          fileName:
            "2023/METROPOLITAN-EMPLOYEE-HANDBOOK-AND-CODE-OF-BUSINESS-CONDUCT-ETHICS.pdf",
          fileType: "PDF",
          fileSize: "451 KB",
        },
        {
    ...
    },
    {
      ...
      title: "2024",
      content:
        "Download our corporate governance materials for 2024, containing current organizational details, compliance measures, and policy updates.",
      documents: [
        {
          id: "2024-1",
          ...
          <div className="relative z-10 container mx-auto px-4 py-8">
            ...
            >
              <h1
                ...
                style={{
                  textShadow:
                    "3px 3px 6px rgba(0, 0, 0, 0.8), -1px -1px 2px rgba(255, 255, 255, 0.5), 0 0 30px rgba(109, 231, 223, 0.6)",
                  color: "#ffffff",
                }}
              >
              ...
              >
                <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-xl p-8">
                  ...
                  <p className="text-slate-600 leading-relaxed mb-8">
                    ...
                    accountability, fairness, and transparency in our
                    relationship with all stakeholders. We continuously review
                    and update our practices to align with industry best
                  ...
                  <div className="border-t border-slate-200 pt-6">
                    ...
                    <ul className="space-y-3 text-slate-600">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Board independence and diversity in leadership
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-teal-600 font-bold mt-1">•</span>
              ...
              >
                <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-xl p-6">
                  ...
                  <p className="text-slate-700 mb-6">
                    Access our official corporate governance materials and
                    reports by year
                  </p>
                          ...
                          <div className="px-6 pb-5 pt-2 border-t border-slate-200 bg-slate-50">
                            ...
                            <div className="space-y-3">
                              {item.documents.map((doc) => (
                                <div
                                  key={doc.id}
                                  className="bg-white rounded-lg p-4 border border-slate-200 hover:border-teal-300 transition-colors"
                                >
            ...
            >
              <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-xl p-6 md:p-8 border border-teal-200 shadow-lg">
                ...
                <p className="text-slate-700 leading-relaxed mb-5">
                  For inquiries regarding our corporate governance practices or
                  to request additional documentation, please contact our
                  Corporate Secretary.
                </p>
                <a
                  href="/#contact"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-all duration-300 font-medium shadow-md hover:shadow-lg"
                >
                  Contact Us
                </a>
              </div>
